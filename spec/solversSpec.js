describe('solvers', function() {
  ...
  describe('findNQueensSolution()', function() {
    ...
    it('finds a valid solution for n of 0-7', function() {
      ...
      // we removed 0 from the array below, because the test tried to 
      // find numPieces of a size-0 board, and crashed. This has nothing to do 
      // with our solver functions. 
